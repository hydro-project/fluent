...
TEST_F(ServerHandlerTest, BasicNodeJoin) {
  ...
  node_join_handler(seed, ip, ip, logger, serialized, global_hash_ring_map,
                    local_hash_ring_map, placement, join_remove_set, pushers,
                    wt, join_addr_keyset_map, 0, serializer);
